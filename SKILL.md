...
---
*Updated: 2026-03-19 - Added `--y-label-limit` for crowded Y-axis labels so long category/value labels truncate cleanly instead of overflowing; version bumped to 2.6.16*
